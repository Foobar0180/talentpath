...
new Chartist.Bar('#social-networks-bar-chart', {
    labels: ['Facebook', 'LinkedIn', 'Twitter', 'Google+'],
    series: [
        [15, 4, 3, 7],
        [3, 2, 9, 5]
    ]
...
//Distributed series
new Chartist.Bar('#sources-bar-chart', {
    labels: ['Indeed', 'LinkedIn', 'Monster', 'CareerBuilder', 'CareerJet', 'Careers Site', 'Manual'],
    series: [53, 39, 46, 27, 49, 33, 17]
}, {
